...
object MyObject {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df2 = spark.read.csv("C:\\Users\\harsh\\Downloads\\Compressed\\New folder\\movies-tmdb-10000.csv")
    val df3=df2.repartition()
//    val count= df3.rdd.getNumPartitions

    System.out.println(df3.collectAsList().size())
    System.in.read()
    spark.stop()
  }
}
